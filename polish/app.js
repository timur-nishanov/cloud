...
function buildModeArt(){
  /* габарит обеих композиций 300×296, детали стоят на общей нижней кромке */
  const parts = $('#mode-cards .m-art[data-art="parts"]');
  if(parts){
    /* «собрать самому»: детали ещё не состыкованы — лежат с зазорами,
       но по одной сетке: общая левая кромка и ровные интервалы */
    parts.innerHTML = `
      <img src="assets/details/plate-cut-L--w.svg" style="left:124px;top:16px;width:96px">
      <img src="assets/details/disc-L--w.svg" style="left:0;top:32px;width:104px">
      <img src="assets/details/plate-holes-L--w.svg" style="left:0;top:152px;width:220px">`;
  }
  const rig = $('#mode-cards .m-art[data-art="rig"]');
  if(rig){
    /* «готовый бандл»: детали состыкованы кромка в кромку, терминалы
       ровно на стыках, провод уходит от кромки плиты к кромке карточки */
    rig.innerHTML = `
      <img src="assets/details/disc-L.svg" style="left:14px;top:48px;width:104px">
      <img src="assets/details/plate-cut-L.svg" style="left:124px;top:56px;width:96px">
      <img src="assets/details/plate-holes-L.svg" style="left:0;top:152px;width:220px">
      <span class="term" style="left:53px;top:139px"></span>
      <span class="term" style="left:159px;top:139px"></span>
      <span class="wire" style="left:220px;top:210px;width:48px"></span>
      <span class="term sm" style="left:211px;top:203px"></span>
      <span class="term sm" style="left:259px;top:203px"></span>`;
  }
}
